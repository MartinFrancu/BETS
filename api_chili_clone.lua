...
--]]
CHILI_CLONE_DIRNAME = LUAUI_DIRNAME .. "Widgets/chili_clone/"
...
function widget:Initialize()
	...
	Chili = VFS.Include(CHILI_CLONE_DIRNAME .. "core_clone.lua", nil, VFS.RAW_FIRST)
