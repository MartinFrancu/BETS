...
return Utils:Assign("Dependency", function()
	--- Accessible fields.
	-- @table Dependency.
	-- @field A_Z__name__ Any slot with a capital first letter represents a @{Dependency} that can be used to track what dependencies are fulfilled and allows the postponing of execution of functions and widgets.
	local Dependency = {}
	...
	-- @usage Dependency.deferWidget(widget, Dependency.CustomName, Dependency.OtherName)
	...
	-- @usage Dependency.clear(Dependency.CustomName)
